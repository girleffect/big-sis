...
The main content of each page is located under the **Content tab** which is organised into sections.<br>
The most common sections under **Content tab** are the **Header Section** and the **Body Section**.<br>
Under the **Promote tab** you can edit the page’s **SEO details** such as the preview title, the meta description and the image of the page for when it appears in search engine results or when it’s posted on social media.<br> Below you can read a description for each page type.
...
The main content of the page is automatically drawn from the data you have entered under the Services option of the Sidebar and the Service pages you created (i.e. Service types, Service locations, Services).
### Service page
For each Service, you need to create a Service page. You can only create a Service page under the Services finder page.<br>
Service pages have a Details section where you can fill in the details of the new Service. This page type does not include Header and Body sections.
### Blog index page
This is a unique page type, therefore you can only have one Blog index page in the hierarchy of your pages.<br>
This page type has the property to automatically display all its child-pages as filters (blog category pages) and articles (post pages).<br>
Therefore, every time you publish a new Blog category page or a new Post page it will automatically appear in your Blog.<br>
...
Creating a new Blog category page under the Blog index page will create a new category filter in the Blogs page (in the example below you can view 4 category filters: Sex; Relationships; Self Love; Category 4).
...
Under the Body Section of the different page types you can create the following sections & blocks:
...
- The forth column has a 60% Grid block with 4 tiles (Column 4).
...
Hover on each item, then click edit to edit the Service Type. To add a new Service Type click on the **Add Service Type** button.<br>

![img_4.png](img_4.png)

Note that the Service Types created here will appear in the filters on the Services Finder page of the website.<br>
...
Hover on each item, then click edit to edit the Service Location. To add a new Service Location click on the **Add Service Location** button.

![img_6.png](img_6.png)

Note that the Service Locations created here will appear in the dropdown field on the Services Finder page of the website.
![img_7.png](img_7.png)


## Editing Global Settings
Clicking on the option **Settings** will expand the admin **Sidebar**. From the expanded Sidebar you can select the option Global Settings.<br>
Through the **Global Settings** you can manage the Footer and add additional scripts in the website (e.g Google Analytics).
...
To delete a script, you can hover over the Script title and click on the delete icon.   
![img_2.png](img_2.png)
### Footer
